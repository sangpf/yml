...
public class MSWordTool {
     ...
     * @param contentMap
     */
    public void replaceBookMark(Map<String,String> contentMap) {
        //循环进行替换
        ...
        while (bookMarkIter.hasNext()) {
            ...
            //进行替换
            String bookValue = contentMap.get(bookMarkName);
            if (bookValue != null) {
                bookMark.insertTextAtBookMark(bookValue, BookMark.INSERT_BEFORE);
            }
        }
    }
    ...
    public void saveAs() {
        File newFile = new File("D:\\1.docx");
